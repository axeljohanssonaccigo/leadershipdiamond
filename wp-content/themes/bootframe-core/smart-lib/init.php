...
class Smartlib_Init{
    ...
    /*flexislider*/
		...
		/*CUSTOM CSS*/
		wp_register_style('diamond-style-common',  get_template_directory_uri() . '/layouts/css/leadership.diamond.common.css', false);
		wp_enqueue_style('diamond-style-common');
		...
		/* Angular */
		wp_register_script('angular', get_template_directory_uri() . '/assets/js/angular.js', array('jquery'), null, true);
		...
		/* CUSTOM SCRIPTS */
		/* Diamond App */
		wp_register_script('diamondApp', get_template_directory_uri() . '/layouts/scripts/app/diamondApp.js', array('jquery'), null, true);
		wp_enqueue_script('diamondApp');
		wp_register_script('startCtrl', get_template_directory_uri() . '/layouts/scripts/app/controllers/startCtrl.js', array('jquery'), null, true);
		wp_enqueue_script('startCtrl');
		wp_register_script('startSvc', get_template_directory_uri() . '/layouts/scripts/app/services/startSvc.js', array('jquery'), null, true);
		wp_enqueue_script('startSvc');
