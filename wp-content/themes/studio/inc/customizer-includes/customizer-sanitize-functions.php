 ...
 */
function studio_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 * @since  Studio 1.0
 */
function studio_sanitize_custom_css( $input ) {
	if ( $input != '' ) { 
 ...
 */
function studio_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function studio_sanitize_page( $input ) {
 ...
 * @since Studio 1.0
 */
function studio_sanitize_category_list( $input ) {
	if ( $input != '' ) { 
		$args = array(
						'type'			=> 'post',
						'child_of'      => 0,
 ...
 *                    the setting default.
 */
function studio_sanitize_number_range( $number, $setting ) {
 ...
 * @since  Studio 1.0
 */
function studio_reset_typography( $input ) {
    if ( $input == 1 ) {
 ...
 * @since  Studio 1.0
 */
function studio_sanitize_footer_code( $input ) {
 ...
 * @since  Studio 1.0
 */
function studio_sanitize_reset_footer_content( $input ) {
    if ( $input == '1' ) {
    	//Reset Footer Editor Options
        set_theme_mod( 'footer_left_content', studio_get_default_theme_options( 'footer_left_content' ) );
    	set_theme_mod( 'footer_right_content', studio_get_default_theme_options( 'footer_right_content' ) );
    }
 ...
 */
function studio_sanitize_important_link() {
	return false;
}
 ...
 * @since  Studio 1.0
 */
function studio_reset_all_settings( $input ) {
	if ( $input == 1 ) {
